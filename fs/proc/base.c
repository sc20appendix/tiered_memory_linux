...
static const struct pid_entry tgid_base_stuff[] = {
	...
	REG("check_a",  S_IRUGO, proc_check_a_operations),
	REG("page_rank",  S_IRUGO, proc_page_rank_operations),
	REG("pmem_emul",  S_IRUGO, proc_pmem_emul_operations),
	REG("pmem_sort",  S_IRUGO, proc_pmem_sort_operations),
#endif
